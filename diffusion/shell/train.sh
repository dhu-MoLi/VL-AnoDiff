...
# # Test script - use fewer steps and a single category
# export name="ms_test_cable_bent_wire"
# export path="mvtec_train_data/cable/bent_wire"
# export word="defect"

# # Ensure config file path is correct
# python main.py \
#   --base configs/latent-diffusion/txt2img-1p4B-finetune-multiscale.yaml \
#   -t --actual_resume models/ldm/text2img-large/model.ckpt \
#   -n $name \
#   --gpus 0, \
#   --data_root $path \
#   --init_word $word \
#   --max_steps 20  # Run only 20 steps to verify functionality

# Run training command
sample_names=("candle" "capsules" "cashew" "chewinggum" "fryum" "macaroni1" "macaroni2" "pcb1" "pcb2" "pcb3" "pcb4" "pipe_fryum")
...
do
    ...
    python main.py \
        ...
        --data_root "visa_train_data_balanced/${sample_name}" \
        --placeholder_string '*' \
        --sample_name "${sample_name}" \
        --gpus 0, \
        --logdir "visa_10_baseline" \
